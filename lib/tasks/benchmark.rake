...
namespace :benchmark do
  ...
  # Generating the tree   345.210000  13.180000 358.390000 (809.084726) 13.48474543333333 min
  ...
  ######################## AWESOME NESTED TREE ########################
  #                              user     system      total        real
  # Displaying tree         16.240000   0.630000  16.870000 ( 18.441325)
  ...
  ######################## AWESOME NESTED TREE ########################
  #                              user     system      total        real
  # Inserting taxon         0.080000   0.010000   0.090000 (  0.273485)
  ...
  ################### AWESOME NESTED TREE ####################
  #                      user     system      total        real
  # Moving a taxon  0.070000   0.010000   0.080000 (  1.816824)
  ...
  ################### AWESOME NESTED TREE ####################
  #                      user     system      total        real
  # Removing a taxon  1.070000   0.070000   1.140000 (  4.353655)
